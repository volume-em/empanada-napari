...
def multigpu_inference_widget():
    from napari.qt.threading import thread_worker
    from napari.qt import progress

    # Import when users activate plugin
    from empanada_napari.orthoplane import tracker_consensus, stack_postprocessing
    ...
    @thread_worker
    def multigpu_inference(engine, volume):
        trackers_dict = {}
        for axis_name in ['xy']:
    ...
    def widget(
        ...
        worker = multigpu_inference(widget.engine, image)
...
def multigpu_inference_dock_widget():
    return multigpu_inference_widget, {'name': 'Experimental'}
